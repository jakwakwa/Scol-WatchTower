...
| Accountant letter form | `form/accountant-letter.submitted` | When product type is not "call_centre" |
...
- **AI Validation Agent**: Gemini-powered analysis of all uploaded documents (bank statements, ID, proof of residence) and the accountant letter form data. Runs validation, risk, and sanctions agents internally.
