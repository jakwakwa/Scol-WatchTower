...
<AccordionGroup>
    ...
    <Accordion icon="rectangle-terminal" title="Start the preview server">
        1. Install the Control Tower Onboard CLI: `npm i -g mint` 2. Navigate to your docs directory and run: `mint dev`
...
<AccordionGroup>
  <Accordion icon="github" title="Install our GitHub app">
    Install the Control Tower Onboard GitHub app from your [dashboard](https://dashboard.mintlify.com/settings/organization/github-app).
