...
function PipelineCard({ workflow }: { workflow: PipelineWorkflow }) {
	...
	const shouldRenderSvgFilters = workflow.id === -1;

	return (
		<>
			<div className="p-7 rounded-xl border border-white/10 shadow-[0px_10px_10px_rgba(0,0,0,0.05)] transition-all group relative select-none">
