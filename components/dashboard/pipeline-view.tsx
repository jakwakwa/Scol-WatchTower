...
const PIPELINE_STAGES = [
    { id: "new", title: "Lead Engagement", color: "border-t-blue-400", icon: RiFileTextLine },
    { id: "contracting", title: "Contracting", color: "border-t-purple-400", icon: RiFileTextLine },
    { id: "fica_review", title: "FICA Review", color: "border-t-amber-400", icon: RiShieldCheckLine },
        ...
        <div className="bg-card/80 backdrop-blur-sm p-4 rounded-xl border border-sidebar-border shadow-sm hover:shadow-md transition-all group cursor-pointer relative hover:border-primary/20">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-sidebar-border/50 mt-2">
                <div className="flex flex-col">
                    <span className="text-[10px] text-muted-foreground uppercase tracking-wide">Mandate</span>
                ...
                <div className="flex flex-col items-end">
                    <span className="text-[10px] text-muted-foreground uppercase tracking-wide">Updated</span>
