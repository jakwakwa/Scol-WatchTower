    ...
    return (
        <section className="relative overflow-hidden py-24 lg:py-32 bg-rich-black text-foreground">
            ...
            <div className="container px-4 md:px-6 mx-auto relative z-10 flex flex-col items-center text-center">
                ...
                >
                    Streamline your workflow with intelligent automations.
                    Seamlessly connect Turso, Clerk, and your favorite tools to deliver
                ...
                >
                    <Link href="/sign-up" className="w-full sm:w-auto">
                        <Button size="lg" className="w-full sm:w-auto gap-2 text-base font-semibold h-12 shadow-lg shadow-primary/20">
                            Get Started <ArrowRight size={18} />
                        </Button>
                    </Link>
                    <Link href="/sign-in" className="w-full sm:w-auto">
                        <Button variant="outline" size="lg" className="w-full sm:w-auto gap-2 text-base h-12 bg-transparent border-secondary/10 hover:bg-secondary/5 text-white">
                            Sign In
                        </Button>
                    </Link>
                </motion.div>
