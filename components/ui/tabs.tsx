...
function TabsTrigger({
	...
	return (
		<TabsPrimitive.Trigger
			...
			className={cn(
				"gap-2 text-white/70 text-shadow-sm uppercase text-[10px]  bg-stone-800 rounded-none data-[state=active]:border-0 min-h-9  rounded-t-xl rounded-b-none px-2 py-1 font-medium group-data-vertical/tabs:px-2.5 group-data-vertical/tabs:py-1.5 [&_svg:not([class*='size-'])]:size-4 focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring  hover:text-white dark:text-muted-foreground shadow-[inset_0px_-1px_1px_1px_rgba(0,0,0,0.3)] dark:hover:text-foreground relative inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center whitespace-nowrap transition-all group-data-[orientation=vertical]/tabs:w-full group-data-[orientation=vertical]/tabs:justify-start focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
...
function TabsContent({
	...
	return (
		<TabsPrimitive.Content
			...
			className={cn(
				"text-sm bg-card rounded-b-3xl p-0 m-0 shadow-2xl shadow-xl/5 flex-1 outline-none",
				className
			)}
			{...props}
		/>
