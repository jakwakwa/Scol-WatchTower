...
ALTER TABLE `activity_logs` ALTER COLUMN "created_at" TO "created_at" integer DEFAULT '"2026-02-26T10:05:05.311Z"';--> statement-breakpoint
...
ALTER TABLE `risk_assessments` ALTER COLUMN "created_at" TO "created_at" integer DEFAULT '"2026-02-26T10:05:05.310Z"';--> statement-breakpoint
ALTER TABLE `applicants` ADD `id_number` text;